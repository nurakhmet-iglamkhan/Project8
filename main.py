...
class chilhood(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowIcon(QtGui.QIcon('images/logo.png'))
        self.labelImg.setPixmap(QPixmap('images/kasha.jpg'))
    ...
    def itemSelect(self):
        answers[0] = self.tableWidget.currentItem().text()
...
class boyhood(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        if answers[1] is not None:
            self.boyhoodLbl1.setText('Выбрано: ' + answers[1])
...
class youth(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        if answers[2] is not None:
            self.YouthLbl1.setText('Выбрано: ' + answers[2])
